...
class ErrorPage extends StatelessWidget {
  ErrorPage(
      {key,
      this.errorMsg = 'Estamos trabajando para solucionarlo',
      this.imageRoute = 'assets/attention.png',
      this.page = true});
  ...
  Widget build(BuildContext context) {
    ...
    final body = Center(
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text(errorMsg,
            style: TextStyle(fontSize: 16, color: Helper.brandColors[8])),
    ...
    return page
        ? Scaffold(
            backgroundColor: Helper.brandColors[1], drawer: null, body: body)
        : body;
  }
}
