...
class _NotificacionesABMState extends State<NotificacionesABM>
...
class _Tabs extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return TabBarView(controller: ctrl, children: [
      _ListNotificaciones(),
      _ListNotificaciones(
        autorizada: true,
      ),
...
class _ListNotificaciones extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
        future:
            _notificacionesService.obtenerNotificaciones(_pref.id, autorizada),
        builder: (context, snapshot) {
          ...
          final notif = snapshot.data as Map<String,dynamic>;
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) => CustomListTile(
                      ...
                      actionOnTap: () => Navigator.pushNamed(
                          context, NotificacionesEditForm.routeName,
                          arguments: {'idNotif': notif[index]['id'] ?? ''}),
                    ));
          else {
            String text;
            if (autorizada)
