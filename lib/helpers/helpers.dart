...
class Helper {
  ...
  static String androidURL =
      'https://play.google.com/store/apps/details?id=com.edrex.veronaapp';
  static int limit = 25;
  ...
  static Future<double> getWeigth(
    XFile file,
  ) async {
  ...
  static  formatIsoDateString(String isoString) {
